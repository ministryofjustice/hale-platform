...
FROM --platform=linux/amd64 wordpress:7.0.4-php8.4-fpm-alpine
...
# Populate ARG values to trigger this patch to run
...
ARG PATCH_WORDPRESS_SHA1="cb61ab543e0b873a63cc30b2a7628dadf4b41951"
