...
wp config set AUTH_KEY "${WORDPRESS_AUTH_KEY_FILE}" --raw
wp config set AUTH_SALT "${WORDPRESS_AUTH_SALT_FILE}" --raw
wp config set LOGGED_IN_KEY "${WORDPRESS_LOGGED_IN_KEY_FILE}" --raw
wp config set LOGGED_IN_SALT "${WORDPRESS_LOGGED_IN_SALT_FILE}" --raw
wp config set NONCE_KEY "${WORDPRESS_NONCE_KEY_FILE}" --raw
wp config set NONCE_SALT "${WORDPRESS_NONCE_SALT_FILE}" --raw
wp config set SECURE_AUTH_KEY "${WORDPRESS_SECURE_AUTH_KEY_FILE}" --raw
wp config set SECURE_AUTH_SALT "${WORDPRESS_SECURE_AUTH_SALT_FILE}" --raw
