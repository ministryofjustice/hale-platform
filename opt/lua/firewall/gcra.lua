...
--     "Intuition of the GCRA" an explainer of GCRA that starts with a
--     rudimentary rate limit bucket, with a guided step by step progression to
--     leaky bucket and virtual leaky bucket.
-- ============================================================================
